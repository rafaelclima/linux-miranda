...
1.
Instale o Ubuntu Server 22.04 LTS:
...
1.
Copie os Arquivos de Boot do PXELINUX:
...
1.
Extraia e Posicione os Arquivos do Rescuezilla:
...
1.
Reinicie e Habilite Todos os Serviços:
...
1.
Crie o arquivo de configuração default:
...
1.
Abra o console de gerenciamento do DHCP no Windows Server.

2.
Vá para IPv4, clique com o botão direito em Opções de Escopo e selecione Configurar Opções....

3.
Marque a Opção 066 - Nome do Host do Servidor de Inicialização:
...
4.
Marque a Opção 067 - Nome do Arquivo de Inicialização:
...
1.
Configure a BIOS/UEFI do Cliente:
